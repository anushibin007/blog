...
readTemplate("$MW_HOME/wlserver/common/templates/domains/wls.jar")
addTemplate("$MW_HOME/wlserver/common/templates/domains/sipserverdomain.jar")
...
writeDomain('$MW_HOME/user_projects/domains/basicWLSSDomain')
closeTemplate()
