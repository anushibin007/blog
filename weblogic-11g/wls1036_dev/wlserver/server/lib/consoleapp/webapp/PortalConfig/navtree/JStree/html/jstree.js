...
function renderTree(node){  
    ...
    this.docObject.write("<LINK REL=\"Stylesheet\" TYPE=\"text/css\" HREF=\"../framework/skins/default/css/wls.css\"><LINK REL=\"Stylesheet\" TYPE=\"text/css\" HREF=\"../utils/JStree/html/jstree.css\">");    
...
function renderNode(node){ 
     ...
     this.docObject.write("<DIV CLASS=bold ID="+node.nodeId+">"+this.getSpacer(node.level)); 
     ...
     if (node.hasChildren() && node.isExpanded){
         ...
         this.docObject.write("<DIV CLASS=bold ID='"+node.nodeId+"CHILDREN"+node.level+"' STYLE='"+getDisplay(node)+"'>");
	    ...
	    if (childNode.hasChildren()){
	       this.renderNode(childNode);     	   
 	        ...
 	        this.docObject.write("<DIV CLASS=bold ID="+childNode.nodeId+">"+this.getSpacer(childNode.level));                 
...
function renderTreeNS(node){         
    ...
    this.docObject.open("text/html");
    this.docObject.write("<HTML><HEAD><LINK REL=\"Stylesheet\" TYPE=\"text/css\" HREF=\"../common/wls.css\"><LINK REL=\"Stylesheet\" TYPE=\"text/css\" HREF=\"../utils/JStree/html/jstree.css\"></HEAD><BODY BACKGROUND=\"images/bg_stripes.gif\" MARGINHEIGHT=\"1\" MARGINWIDTH=\"0\" LEFTMARGIN=\"0\" TOPMARGIN=\"1\">");
